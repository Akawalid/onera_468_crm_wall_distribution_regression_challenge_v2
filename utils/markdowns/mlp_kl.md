...
![One residual's contribution to a fixed bin: step vs smooth](figures/fig3_step_vs_smooth.png)
...
![Hard one hot assignment vs soft softmax assignment](figures/fig2_soft_assignment.png)
...
![Effect of minimizing the KL](figures/fig4_effect.png)
