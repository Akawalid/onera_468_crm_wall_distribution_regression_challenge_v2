...
def main():
    ...
    print(f'sigma_ref = 1% of global mean = {0.01 * mean_global:.5f}')
    ...
    print('Training MLP (loss = sum of per simulation weighted KL, global reference)...')
    ...
    torch.save({'state_dict': model.state_dict(),
                ...
                'sigma_scale': SIGMA_SCALE, 'mean_global': mean_global,
                'best_epoch': best_epoch},
               'mlp_klw_globalref.pt')
    print(f'Saved: mlp_klw_globalref.pt (best epoch {best_epoch})')
    ...
    for label, res in [('Phase 1 (global MLP, global ref)', res1), ('Phase 2 (global MLP, global ref)', res2)]:
...
#==================== Première version, reférence sigma y par simulation
...
#============ version avec early stopping, dropout et la merde qu'il a rajouté le beta... pour la référence
